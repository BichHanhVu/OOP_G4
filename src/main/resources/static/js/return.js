document.getElementById("actualReturnDate").value = new Date().toISOString().slice(0, 10);
...
document.getElementById("returnForm").addEventListener("submit", async event => {
    ...
    try {
        ...
        document.getElementById("fineAmount").textContent = `${Number(result.fineAmount).toLocaleString("vi-VN")} đ`;
